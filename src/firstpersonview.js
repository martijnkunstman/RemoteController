...
// ─── Team colors ──────────────────────────────────────────────────────────────
const TEAM_COLOR = {
  blue: { d: [0.20, 0.40, 0.95], e: [0.05, 0.10, 0.38], g: [0.30, 0.50, 1.00] },
  red:  { d: [0.95, 0.20, 0.20], e: [0.38, 0.05, 0.05], g: [1.00, 0.30, 0.30] },
}
...
function createVehicle(id, team) {
  ...
  return { pivot, pyramid, mat, glow, state, bullets, team }
}
